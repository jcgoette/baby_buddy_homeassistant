...
class BabyBuddyCoordinator(DataUpdateCoordinator):
    ...
    def __init__(self, hass: HomeAssistant, config_entry: ConfigEntry) -> None:
        ...
        self.selected_timer_child_id: int | str | None = None
    ...
    async def async_set_children_from_db(self) -> None:
        ...
        self.child_ids = [
            ...
            if next(iter(device.identifiers))[1] != "hub"
        ]
    ...
    async def async_remove_deleted_children(self) -> None:
        ...
        for device in dr.async_entries_for_config_entry(
            ...
            if device_id != "hub" and device_id not in self.child_ids:
    ...
    async def async_update(
        ...
        if not self.selected_timer_child_id and children_list[ATTR_RESULTS]:
            self.selected_timer_child_id = children_list[ATTR_RESULTS][0][ATTR_ID]
